...
function hide_text(post){ 
        document.getElementById(post).classList.remove('showText')
}
function show_text(post){ 
        document.getElementById(post).classList.add('showText')
}
</script>
